    ...
    return (
        <div className='flex p-4 border-b dark:border-gray-600 text-sm'>
            ...
            <div className='flex-1'>
                ...
                {isEditing ? (
                    <>
                        <Textarea className='min-h-10 max-h-80 sm:max-h-40 bg-white dark:bg-[rgb(22,26,29)]' placeholder='Edit the comment...' maxLength='200' onChange={(e) => setEditedContent(e.target.value)} value={editedContent} />
                        <div className='flex justify-between items-center mt-3'>
                            <p className='text-gray-500 dark:text-gray-400 text-xs'>{200 - editedContent.length} characters remaining</p>
                    ...
                    <>
                        ...
                        <div className='flex items-center pt-2 text-xs border-t dark:border-gray-600 max-w-fit gap-2'>
                            <button type='button' onClick={() => onLike(comment._id)} className={`text-gray-400 hover:text-sky-500 dark:hover:text-sky-300 ${currentUser && comment.likes.includes(currentUser._id) && '!text-sky-600 dark:!text-sky-400'}`}>
